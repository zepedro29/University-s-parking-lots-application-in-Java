...
public class JanelaTabelaPedidosRecusados extends javax.swing.JFrame {
    ...
    public JanelaTabelaPedidosRecusados(Sistema sistema, Serializacao bd) {
        initComponents();
    ...
    private AbstractTableModel criarTabela() {
        ...
        return new AbstractTableModel() {
            ...
            public int getRowCount() {
                return sistema.getPedidos().listarPedidosEstado(EstadoPedido.RECUSADO).size();
            }
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                Pedido p = sistema.getPedidos().listarPedidosEstado(EstadoPedido.RECUSADO).get(rowIndex);
                switch (columnIndex) {
                    case 0:
